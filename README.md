...
On-chain deliverable of **ARP (Agent Reputation Protocol)** — the Intuition-native reputation layer for ERC-8004 agents.
...
- **Chain**: IntuitionTestnet → Intuition mainnet (later)
